...
{
    public class RoleBattleChess : FixTargetBuffProperty<RoleBattleChess>,
        IBattleChess, ICanAttack, ICanDefend, IHasContent, IReleasable
    {
        ...
        public RoleBattleChess Belong => this;

        public HexUnit Unit { get; set; }

        protected override RoleBattleChess Target => this;
        ...
        public RoleBattleChess(Role role, IObjectAccessor<HexUnitPlay> unitPlay)
        {
            Role = role;
