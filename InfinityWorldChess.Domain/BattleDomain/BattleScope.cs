...
namespace InfinityWorldChess.BattleDomain
{
    ...
    {
        private static MonoContainer<BattleMap> _map;
        private static PrefabContainer<HexUnit> _battleUnitPrefab;
        private static PrefabContainer<TextMeshPro> _simpleTextMesh;
        ...
        public BattleScope(IwcAb ab)
        {
            ...
            _map.Create();
            _map.Value.Grid.HexMapManager = U.Get<IBattleHexMapManager>();
        }
